...
class LetterGridWidget extends StatelessWidget {
  final List<EnglishNumberModel> letters;
...
class LetterCardWidget extends StatelessWidget {
  final EnglishNumberModel letter;
  final int index;
  final AnimationController floatingController;
  final EnglishNumberTheme currentTheme;
  final Function(EnglishNumberModel, Offset) onLetterTap;
...
class ThemeSpecificCardWidget extends StatelessWidget {
  ...
  /// 📖 Storybook Theme
  Widget _storybookCardWidget(EnglishNumberModel letter, int index) {
  ...
  /// ✨ Holographic Theme
  Widget _holographicCardWidget(EnglishNumberModel letter) {
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          begin: Alignment.topLeft,
  ...
  /// 🧚 Enchanted Theme
  Widget _enchantedCardWidget(EnglishNumberModel letter, int index) {
  ...
  /// 🌊 Ocean Theme
  Widget _oceanCardWidget(EnglishNumberModel letter) {
...
class ReadingOverlayWidget extends StatelessWidget {
  final EnglishNumberModel selectedLetter;
  final EnglishNumberTheme currentTheme;
